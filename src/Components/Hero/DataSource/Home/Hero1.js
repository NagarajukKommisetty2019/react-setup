...
export const Hero1 = () => {
    return {    
         key: 1,
         heading:"Hero H1 Title",         
         subheading:"Second Subheading",
         bodyCopy:<p className="c-paragraph-2 pb-3 pt-0">Hero body copy</p>,
         links:<a target="_blank" href="#" aria-label="Click to start your Link" className=" mb-1 c-call-to-action c-glyph x-hidden-focus" id=""><span>LOREM ISPSUM</span></a>,
